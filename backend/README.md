...
## Project Structure
    ...
    ├── sparkling_queen_dev_80536  # Django project configurations
...
1. Clone this repo and `cd sparkling_queen_dev_80536`
...
2. Clone this repo and `cd sparkling_queen_dev_80536`
